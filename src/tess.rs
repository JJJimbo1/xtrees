...
mod tess {
    ...
    impl Tess {
        pub fn new(x : f32, y : f32, z : f32, w : f32, half_x : f32, half_y : f32, half_z : f32, half_w : f32,) -> Self {
            Self {
                x,
                y,
                z,
    ...
    impl Dimension for Tess {
        ...
        fn overlaps(&self, area : &Self) -> bool {
            ...
            if (self.z - area.z).abs() > (self.half_z + area.half_z) { return false; }
            if (self.w - area.w).abs() > (self.half_w + area.half_w) { return false; }
        ...
        fn subdivisions(&self) -> [Self; Self::SUB_COUNT] {
            ...
            [xbsw, xbse, xbnw, xbne, xasw, xase, xanw, xane, ybsw, ybse, ybnw, ybne, yasw, yase, yanw, yane]
        }
    }
